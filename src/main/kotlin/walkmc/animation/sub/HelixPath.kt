 ...
 */
open class HelixPath(var particle: ParticleData, var center: Location) : SubPrimaryAnimation {
   var max = 16f
   var torsion = 0.0
   var distance = 1f
...
inline fun StandAnimation.helix(
   ...
   start: Location = location,
   block: HelixPath.() -> Unit
): HelixPath = addSub(HelixPath(particle(particle), start).apply(block))
...
inline fun StandAnimation.helix(
   ...
   start: Location = location,
   block: HelixPath.() -> Unit
): HelixPath = addSub(ticks, HelixPath(particle(particle), start).apply(block))
...
fun StandAnimation.helix(
   particle: Particle,
   start: Location = location,
): HelixPath = addSub(HelixPath(particle(particle), start))
...
fun StandAnimation.helix(
   ...
   particle: Particle,
   start: Location = location,
): HelixPath = addSub(ticks, HelixPath(particle(particle), start))
